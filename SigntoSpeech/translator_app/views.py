...
import nltk
nltk.download('C:/Users/Nivin/AppData/Roaming/nltk_data')
...
def animation_view(request):
    if request.method == 'POST':
        ...
        return render(request, 'translator_app/animation.html', {'words': words, 'text': text})
    else:
        return render(request, 'translator_app/animation.html')
