...
def load_model():
    json_file = open("C:/Users/nisha/OneDrive/Desktop/project2/authentication/learning_app/model.json", "r")
    model_json = json_file.read()
    json_file.close()
    model = model_from_json(model_json)
    model.load_weights("C:/Users/nisha/OneDrive/Desktop/project2/authentication/learning_app/model.h5")
    return model
